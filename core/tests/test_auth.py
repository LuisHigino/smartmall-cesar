...
class TestRegistroLojista:
    ...
    def test_registro_lojista_sucesso(self, browser, live_server_url, categoria):
        """Teste: Registro de lojista cria usuário e loja."""
        browser.get(f'{live_server_url}/registro-lojista/')
        
        browser.find_element(By.NAME, 'username').send_keys('novo_lojista')
        browser.find_element(By.NAME, 'email').send_keys('novo@teste.com')
        browser.find_element(By.NAME, 'password1').send_keys('Senha@123')
        browser.find_element(By.NAME, 'password2').send_keys('Senha@123')
        browser.find_element(By.NAME, 'nome_loja').send_keys('Nova Loja')
        browser.find_element(By.NAME, 'cnpj').send_keys('98.765.432/0001-10')
        browser.find_element(By.NAME, 'responsavel').send_keys('Maria Santos')
        
        categoria_select = Select(browser.find_element(By.NAME, 'categoria'))
        categoria_select.select_by_visible_text(categoria.nome)
        ...
        assert User.objects.filter(username='novo_lojista').exists()
        assert Loja.objects.filter(cnpj='98.765.432/0001-10').exists()
